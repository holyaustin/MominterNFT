 ...
 */}
    ...
    <div className="p-4">
                ...
                <div className="p-4">
                <ShareLink link="https://mominternft.vercel.app/explore" text="News on Demand from eye witness all around the globe!" hashtags="blockchaintechnology Mominter huddle01 holyaustin IPFS Lighthouse">
              {(link) => (
                  <button type="button" className="w-full bg-blue-800 text-white font-bold py-2 px-12 border-b-4 border-blue-200 hover:border-blue-500 rounded-full">                   
